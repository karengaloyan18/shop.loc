...
<div class="container">
    <form action="{{--{{route('editproduct',['product'=>$product->id])}}--}}#" method="post"
        ...
        <div class="col-4">
            ...
            <input id="name" type="text" name="name" value="{{$products['name']}}" class="form-control inputstyle">
        ...
        <div class="col-4">
            ...
            <input id="price" type="text" name="price" value="{{$products['price']}}" class="form-control inputstyle">
        ...
        <div class="col-8">
            ...
            <input id="description" type="text" name="description" value="{{$products['description']}}" class="form-control inputstyle">
